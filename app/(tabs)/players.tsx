...
const createStyles = (c: ThemeColors, isDark: boolean) => StyleSheet.create({
    ...
    headerTitle: { color: c.text, fontSize: 18, fontFamily: FONT_DISPLAY_EXTRABOLD },
    ...
    dupBannerBtn: { backgroundColor: 'rgba(255,255,255,0.25)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 6 },
    dupBannerBtnText: { color: c.text, fontFamily: FONT_DISPLAY_EXTRABOLD, fontSize: 12 },

    // Merge modal
    mergeContainer: { backgroundColor: c.modalBg, borderTopLeftRadius: 16, borderTopRightRadius: 16, maxHeight: '85%' },
    mergeScroll: { paddingHorizontal: 16 },
    mergeIntro: { color: c.textMuted, fontSize: 14, lineHeight: 20, marginBottom: 16, fontFamily: FONT_BODY_REGULAR },
    dupGroupCard: {
    ...
    dupGroupHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
    dupGroupName: { fontSize: 16, fontFamily: FONT_DISPLAY_BOLD, color: c.text },
    dupGroupCount: { fontSize: 12, color: c.textSoft, marginTop: 4, fontFamily: FONT_BODY_REGULAR },
    mergeGroupBtn: {
        flex: 1,
        flexDirection: 'row',
        alignItems: 'center',
    ...
    dupPlayerMeta: { fontSize: 12, color: c.textMuted, marginTop: 4, fontFamily: FONT_BODY_REGULAR },
    dupPlayerGroups: { fontSize: 12, color: c.textSoft, marginTop: 4, fontFamily: FONT_BODY_REGULAR },
    dupActionRow: {
        flexDirection: 'row',
        gap: 12,
        marginTop: 12,
    ...
    modalContainer: { backgroundColor: c.modalBg, borderTopLeftRadius: 16, borderTopRightRadius: 16, maxHeight: '85%' },
    ...
    modalTitle: { fontSize: 18, fontFamily: FONT_DISPLAY_BOLD, color: c.text },
    modalBody: { padding: 16 },
    label: { fontSize: 12, fontFamily: FONT_BODY_SEMIBOLD, color: c.textMuted, marginBottom: 8, marginTop: 12 },
    input: { backgroundColor: c.inputBg, borderRadius: 8, padding: 12, fontSize: 14, borderWidth: 1, borderColor: c.inputBorder, color: c.inputText, fontFamily: FONT_BODY_REGULAR },
    ...
    courtBackText: { color: c.secondary, fontSize: 14, fontFamily: FONT_BODY_SEMIBOLD },
    courtPickerTitle: { fontSize: 16, fontFamily: FONT_DISPLAY_BOLD, color: c.text },
    courtOption: {
        flexDirection: 'row',
        alignItems: 'center',
        padding: 12,
    ...
    courtOptionText: { fontSize: 14, fontFamily: FONT_BODY_SEMIBOLD, color: c.text },
    courtOptionSub: { fontSize: 12, color: c.textSoft, marginTop: 4, fontFamily: FONT_BODY_REGULAR },
