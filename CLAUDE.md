...
**How to sync it (AIOS Build lives on OUR server, /var/www/aiosbuild; project id=10 = PlayPBNow):**
...
2. Re-run AIOS Build's OWN scanner and save it to the live page:
   `ssh root@64.227.108.128 'cd /var/www/aiosbuild && php bin/aios-status.php --save-scan --project=10 --path=/tmp/pbn_scan'`
